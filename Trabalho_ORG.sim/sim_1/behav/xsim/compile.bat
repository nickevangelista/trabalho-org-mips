...
REM
REM Generated by Vivado on Wed Dec 03 10:11:37 -0300 2025
...
echo "xvhdl --incr --relax -prj tb_datapath_soma_vhdl.prj"
call xvhdl  --incr --relax -prj tb_datapath_soma_vhdl.prj -log xvhdl.log
